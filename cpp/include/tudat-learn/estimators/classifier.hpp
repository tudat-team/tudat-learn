...
class Classifier : public Estimator<Datum_t, Label_t> {
  protected:
    ...
    /**
     * @brief Protected constructor, ensuring it is only called from the classes that inherit from Classifier.
  ...
  public:
     ...
     * 
     * @param fit_indices Vector with the indices of the feature vectors to which the Classifier is going to be fitted.
     */
